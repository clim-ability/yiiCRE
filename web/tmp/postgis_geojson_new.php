...
$conn = new PDO('pgsql:host=localhost;dbname=packt','postgres','postgres');
# Build SQL SELECT statement and return the geometry as a GeoJSON element
$sql = 'SELECT *, public.ST_AsGeoJSON(public.ST_Transform((geom),4326),6) AS geojson FROM climate_ex_wgs84';
/*
