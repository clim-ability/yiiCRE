...
function drawEarth(scene) {
  ...
  var earthColor = THREE.ImageUtils.loadTexture(eonetBaseUrl + '/images/earth/earthmap1k.jpg');
  earthColor.minFilter = THREE.LinearFilter;
  var earthBumps = THREE.ImageUtils.loadTexture(eonetBaseUrl + '/images/earth/earthbump1k.jpg');
  earthBumps.minFilter = THREE.LinearFilter;
  var earthSpecular = THREE.ImageUtils.loadTexture(eonetBaseUrl + '/images/earth/earthspec1k.jpg');
